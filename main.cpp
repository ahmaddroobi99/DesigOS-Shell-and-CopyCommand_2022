...
void copyfile(char input[] ,char output [],char beg[],char skip[] ){
// Algorithm
  // 1. count chars
...
if (inMyStream.is_open()) 
{
 ...
 char store[c] ;
  ...
  readFromFile(input,store,count ); 
...
char ss [100]; 
  ...
  writeToFile(output,store,count , atoi(beg),atoi(skip));
...
int ownCmdHandler(char** parsed)
{
    ...
    case 4:
        ...
        return 1;
   case 5:
        copyfile(parsed[1] ,parsed[2],parsed[3],parsed[4]);
     	return 1;
